...
#' @description
#' Create a new \code{R6ProgressBar}.
#'
...
#'   format string (default \code{"\%d"}) that is evaluated with the
#'   current counter value, or a character vector of length \code{max}
#'   providing per-step labels.
